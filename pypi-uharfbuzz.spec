...
Source0  : https://files.pythonhosted.org/packages/3e/d8/ffabf2d782e93dd17984d409cbf9d13182e022e8e2a998ff9b8ab933d27a/uharfbuzz-0.31.0.zip
...
%prep
%setup -q -n uharfbuzz-0.31.0
cd %{_builddir}/uharfbuzz-0.31.0
pushd ..
cp -a uharfbuzz-0.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666743949
