...
Source0  : https://files.pythonhosted.org/packages/40/20/0d8066895bd262f8b85e4148c5ff467826d9facea36a5e4e25f883756e2f/uharfbuzz-0.39.1.zip
...
%prep
%setup -q -n uharfbuzz-0.39.1
cd %{_builddir}/uharfbuzz-0.39.1
pushd ..
cp -a uharfbuzz-0.39.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710781549
